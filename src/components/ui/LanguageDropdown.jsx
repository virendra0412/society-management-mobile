...
const LanguageDropdown = () => {
  ...
  // Find current locale — fall back to LOCALES.en if not found
  const current = Object.values(LOCALES).find((l) => l.nativeLabel === locale)
    ? LOCALES[locale]
    : LOCALES.en;
  ...
  return (
    <>
      <TouchableOpacity
        ...
        style={styles.pill}
      >
        <Text style={styles.pillText}>🌐 {current.nativeLabel}</Text>
